...
/*
 * Changed by Edd King 20/09/2013
 * This is a derivative of the original, which can be found in Apache Solr.
 *
 * Changes:
 * - Removed dependency on SolrRequestInfo
 * - Changed Constructor to use default TimeZone and Locales
 * - Changed package
 */
...
public class DateMathParser  {
  ...
  /**
   * Default constructor that assumes UTC should be used for rounding
   *
   * @see #DEFAULT_MATH_LOCALE
   */
  public DateMathParser() {
      this.loc = DEFAULT_MATH_LOCALE;
      this.loc = DEFAULT_MATH_LOCALE;
  }
